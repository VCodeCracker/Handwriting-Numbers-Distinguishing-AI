...
import org.example.SigmoidNetwork;
...
public class FormDigits extends JFrame implements Runnable, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static SigmoidNetwork nn;

    public FormDigits() throws IOException, ClassNotFoundException {
        this.nn = (SigmoidNetwork) deserialize();
    ...
    public void paint(Graphics g) {
        ...
        double[] outputs = nn.feedForward(new DoubleMatrix(inputs)).toArray();
